...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {    
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/api/ledger/transaction").permitAll()	
		.antMatchers(HttpMethod.GET, "/api/ledger/transaction/**").permitAll()	
		.antMatchers(HttpMethod.POST, "/api/ledger/transaction").permitAll()
		.antMatchers(HttpMethod.POST, "/api/ledger/transaction/update").permitAll()
		.antMatchers(HttpMethod.PUT, "/api/ledger/transaction").permitAll()	
